...
<div>
	<div style="background-color: #578BB8;height: 24px;margin-bottom: 1px;">
		<a href="${path }/userModule/toOverView.php" class="a_style"><img height="20px" src="${path}/pic/home32.png"><font class="font_style">主页</font></a>
		...
		<div style="float: right;font-size: 14;padding-right: 3%;margin-top: 2px;color: white;font-weight: bold;">登录为：<%=user.getName() %>  <a href="javascript:void(0)" class="a_style" onclick="logout()">退出登录</a></div>
	</div>
	...
	<div style="height: auto;margin-top: 1px;background-color: #578BB8;width: 100%;height: 22px">
		<div style="float: left;background-color: white;">
			<div class="linked_div"><a href="${path }/userModule/toOverView.php" class="a_style">概述</a></div>
			...
			<div class="linked_div"><a href="${path }/userModule/toEditUser.php" class="a_style">个人中心</a></div>
		</div>&nbsp;
	</div>
</div>
<script type="text/javascript">
function logout(){
	window.location.href="../loginModule/toLogin.php";
}
</script>
</html>