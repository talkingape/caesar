...
<div>
	<div style="background-color: #578BB8;height: 24px;margin-bottom: 1px;">
		...
		<div style="float: right;font-size: 14;padding-right: 3%;margin-top: 2px;color: white;font-weight: bold;">登录为：${userName}</div>
	</div>
	...
	<div style="height: auto;margin-top: 1px;background-color: #578BB8;width: 100%;height: 22px">
		<div style="float: left;background-color: white;">
			...
			<div class="linked_div"><a href="javascript:void(0)" class="a_style">新建任务</a></div>
			<div class="linked_div"><a href="javascript:void(0)" class="a_style">搜索任务</a></div>
