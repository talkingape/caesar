...
<body background="${path}/pic/loginBackground.jpg">
	<div align="center" style="padding-top: 120px">
		<font size="20" color="#FFFFFF" style="font-weight:bold;font-family: '幼圆'">凯&nbsp;&nbsp;撒 &nbsp;项 &nbsp;目 &nbsp;管 &nbsp;理 &nbsp;系&nbsp;&nbsp;统</font>
	</div>
	<div style="height: auto; width: 32%; margin-left: auto; margin-right: auto; margin-top: 6%">
		<form id="loginInfo">
		<div id="p" class="easyui-panel" title="请登录" style="padding-left: 60px;padding-right: 60px;padding-top: 10px;padding-bottom: 10px"
			data-options="footer:'#ft',cls:'alpha'">
			<div style="margin-bottom: 20px">
				<div><font size="3">用户名:</font></div>
...
function changeCAPTCHA(){
	...
	prop[3]='ch';
	prop[4]='ch';
	$("#validateCodeImg").attr("src","${path}/captcha/draw.php?createTypeFlag="+prop[level%4]+"&id="+parseInt(1000*Math.random()));
}
function login(){
	if($("#userName").val()!=''){
		if($("#passWord").val()!=''){
				...
				$.ajax({
					...
					success : function(data){
						if(data=='"captchafailed"'){
							...
							window.location.href="{path}/jsp/userManagement.php";
						}
					}
				});
			}else{
